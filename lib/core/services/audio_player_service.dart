...
class AudioPlayerService {
  ...
  Future<bool> playFromBase64(String base64Audio) async {
    try {
      ...
      final String tempPath = '${tempDir.path}/temp_audio_${DateTime.now().millisecondsSinceEpoch}.aac';
  ...
  Future<void> stopPlayback() async {
    try {
      if (_isPlaying) {
        ...
        // ลบไฟล์ชั่วคราวถ้ามี
        if (_currentPlayingFile != null && _currentPlayingFile!.contains('temp_audio_')) {
